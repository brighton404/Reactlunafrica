...
const Footer: FunctionComponent = () => {
  ...
  return (
    <footer
      className="bg-base-black w-[1440px] flex flex-col items-start justify-start py-[30px] px-5 box-border text-left text-xl text-primary-pallete-primary font-small-screen-subheading lg:w-[1200px] md:w-[960px] sm:w-[420px]"
      id="footer"
    >
