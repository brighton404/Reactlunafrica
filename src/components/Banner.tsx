...
const Banner: FunctionComponent = () => {
  return (
    <div
      className="bg-base-blacks-var-1 w-[1440px] overflow-hidden flex flex-row items-center justify-start pt-10 px-5 pb-0 box-border gap-[20px] text-left text-13xl text-base-whites-var-1 font-wide-screen-body-small lg:w-[1200px] md:w-[960px] sm:w-[420px] sm:flex-col"
      id="banner-cta"
    >
